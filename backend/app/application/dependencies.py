...
from app.infrastructure.dependencies import get_news_repository, get_user_repository
...
def get_auth_service(repository: IUserRepository = Depends(get_user_repository)):
